...
namespace DavidJalbert
{
    ...
    public class TinyCarController : MonoBehaviour
    {
        ...
        [SerializeField] private TinyCarSurface surface;

        private bool TakeControl => mainController.TakeControl;
        ...
        void OnDestroy()
        {
            ...
            if (sphereCollider != null) sphereCollider.hideFlags = HideFlags.None;
        }
